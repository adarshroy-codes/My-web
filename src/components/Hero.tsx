    ...
    >
      ...
      <div className="text-center z-10 max-w-4xl flex flex-col items-center">
        ...
        <motion.div
          ...
          className="flex items-center gap-2.5 mb-5 px-4.5 py-1.5 rounded-full border border-[rgba(255,255,255,0.24)] bg-[rgba(18,10,36,0.68)] text-[10px] font-orbitron font-extrabold tracking-[0.32em] text-white uppercase shadow-[0_0_25px_rgba(138,63,252,0.35)] backdrop-blur-xl"
        >
          <Gamepad2 className="w-3.5 h-3.5 animate-pulse text-cyber-magenta glow-magenta" />
          GAME DEVELOPER
        </motion.div>
